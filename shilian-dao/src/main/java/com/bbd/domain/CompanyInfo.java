...
public class CompanyInfo {
    ...
    private String annualEmails;

    private String annualPhones;
    ...
    public String getAnnualEmails() {
        return annualEmails;
    }

    public void setAnnualEmails(String annualEmails) {
        this.annualEmails = annualEmails;
    }

    public String getAnnualPhones() {
        return annualPhones;
    }

    public void setAnnualPhones(String annualPhones) {
        this.annualPhones = annualPhones;
    }
