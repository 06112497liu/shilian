 ...
 */
public class CompanyEsVO extends EsBase implements Serializable {

    private static final long serialVersionUID = -677611784756914130L;
    ...
    /**
     * 企业经营活动状态。0.正常企业；1.失联企业；2.已吊销未注销企业；4.严重违法企业
     */
