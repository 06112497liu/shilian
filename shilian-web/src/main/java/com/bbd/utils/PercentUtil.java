...
public class PercentUtil {
     ...
     * @param infos 节点的列表
     */
    public static void calcPercents(List<NameValueNodeInfo> infos) {
        if (infos.size() > 0) {
    ...
    public static void calcLongPercents(List<NameValueNodeInfo> infos) {
        if (infos.size() > 0) {
     ...
     * @param infos 节点的列表
     */
    public static void calcPercents(NameValueNodeInfo[] infos) {
        if (infos.length > 0) {
